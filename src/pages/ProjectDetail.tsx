...
export default function ProjectDetail() {
  ...
  if (!project) return <div className="flex min-h-screen items-center justify-center"><p>Project not found.</p></div>;
      ...
      <main className="container max-w-4xl py-8">
        ...
        <div className="flex items-center justify-between mb-4">
          <h2 className="font-display text-xl font-bold">
            {isBuilder ? `Quotes Received (${quotes.length})` : "Your Quotes"}
          </h2>
          {role === "contractor" && project.status === "open" && (
            <Button asChild><Link to={`/projects/${id}/submit-quote`}>Submit Quote</Link></Button>
          )}
        </div>
